...
| **Графика** | Photopea, Favicon.io, Nana Banana (нейросеть) |
...
**Генерация логотипа:**
- Использована нейросеть **Nanabanana** для создания брутального логотипа в тайском стиле
...
**Создание фавикона:**
- В **Nanabanana** сгенерировано стилизованное изображение тайского боксера, обработано в Photopea
